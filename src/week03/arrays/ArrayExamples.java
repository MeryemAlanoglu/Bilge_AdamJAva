...
public class ArrayExamples {
    public static void main(String[] args) {
        ...
        int[] numbers= new int[30];
                ...
                //içerisinde 18 tane dubble array saklayabilcek
        double[] doubleArray= new double[18];

        //içeriswinde 10,15,20 değerlerini barındıran long array

        //yöntem bir -> direct instaiate
        long[]longArray={10,15,20};

        //yöntem iki -> allocate first,assign later
